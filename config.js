const ownerNumber = ["33660217049@s.whatsapp.net"] 
// mude somente o numero e não tire o @s.whatsapp.net

const OriginalOwner = '33660217049' 
...
const menumsgimg = (numero, groupname, battery) => {
    return `MENU DO LIGHT-BOT COM 434 COMANDOS, BATERIA: ${battery}`
}
...
const banmsgtype = '*Corra miembro comum, o ban estar próximo*'
...
const adminmsgtype = '*Tu ers adm no te voy a baniat por mandar um tipo de mensagem proibida*'
// mensagem de quando adm manda tipos de mensagens proibidas

const banmsgporn = 'Hmmm pornozinho com antiporn ativado, ja sabe né...'
// mensagem de ban no antiporn

const adminmsgporn = '*Tu eres adm no voy a baniar por mandar porn*'
...
const notregister = `*Comando no registrado, escrriba${prefix}menu para ver a lista de comandos*`
...
let mess = {
    ...
    only: {
        ...
        admin: '❌ SILÊNCIO MEMBRO COMUM USTEDED NO TIENE PERMISO PARA USAR ESTE COMANDO ❌',
        Badmin: '❌ Este comando solo pude ser usado cuando el bot sea admi! ❌'
    }
}
...
+ 'FN:Meu criador^~^\n' 
+ 'ORG:Ian;\n' 
+ 'TEL;type=CELL;type=VOICE;waid=+33660217049:+33 6 60 21 70 49\ n' 
+ 'END:VCARD'
